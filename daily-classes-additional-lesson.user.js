// ==UserScript==
// @name         Daily Classes - Additional Lesson Lookup
// @namespace    http://tampermonkey.net/
// @version      3.0
// @description  Fetch additional course lectures from GitHub, copy to clipboard on click
// @author       You
    ...
    function parseStudents(html) {
        ...
        rows.forEach(function (row) {
            ...
            entries.push({
                ...
                book: book,
                page: pageNum[0],
                url: BASE + '/data/' + toKebab(dept) + '/' + toKebab(book) + '/page-' + pageNum[0] + '.md'
            });
        });
